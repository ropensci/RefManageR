...
## They both are 'OR' searches: calls to `[.BibEntry` with args. i and j
## present and lead to `[.BibEntry` being called recursively
## (unlike any calls currently in test-search.R)
