...
- id: bertram
  ...
  annotation: An textttarticle entry with a textttvolume and a textttnumber field
- id: "doody"
  type: "Article"
  author: 
  - given: "Terrence"
    family: "Doody"
  title: "Hemingways Style and Jake/s Narration"
  year: "1974"
  volume: "4"
  number: "3"
  pages: "212-225"
  ...
  langidopts: "variant=american"
  related: 'matuz:doody'
  relatedstring: autocapexcerpt in
  journal: The Journal of Narrative Technique
  annotation: An textttarticle entry cited as an excerpt from atextttcollection entry.
...
...
Some ppers on the arXiv are `r TextCite(bib, eprinttype = "arxiv")`.  A reference to @doody and [@bertram].
