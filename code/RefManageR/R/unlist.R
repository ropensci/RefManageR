#' Flatten and unflatted BibEntry objects
#' 
#' Flattens a BibEntry object to a single list where every field (including \code{bibtype} and \code{key})
...
#' @return a list with bib entries collapsed into a single list.
#' @note The names of the list elements will not be unique.  To do this see \code{\link{make.unique}}.
