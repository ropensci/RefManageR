...
BibOptions(check.entries = FALSE, style = "markdown", bib.style = "alphabetic", cite.style = 'alphabetic', sorting = "none")
bib <- sort(bib, return.labs = TRUE)
...
plot(cars)
```
`r NoCite(bib = bib, title = "CTAN")`I've added a reference to CTAN without citing it.  Now I'm adding a reference from another bibliography (a second `BibEntry` object) `r AutoCite(bib2, title = "retrospective sampling problems")`.  Look at all my Aristotle: `r AutoCite(bib, author = "Aristotle")`.  
