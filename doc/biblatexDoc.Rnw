...
\usepackage{listings}
\lstset{%
basicstyle=\small\ttfamily\itshape\color{black},
...
<<BibEntry1, tidy=FALSE, highlight=FALSE, echo=-1>>=
...
<<arxiv, tidy=FALSE, highlight=FALSE, cache=TRUE>>=
...
<<CrossrefEx, tidy=FALSE, highlight=FALSE, cache=TRUE>>=
...
\ourpkg{} recognizes some, but not all, localization keys defined by default in \Biblatex{}.  A localization key is a special value that \Biblatex{} parses for certain fields and replaces with predefined text called the `localization string` when printing the bibliography.  In the example below I use localization keys to specify the roles of editors using the `editortype` field and refer to portions of a text using the `bookpagination` field.
 <<Book, tidy=FALSE, highlight=FALSE, cache=TRUE>>=
...
<<ReadZotero, tidy=FALSE, highlight=FALSE, echo=-1, cache=TRUE>>=
knit_theme$set('fine_blue')
...
<<ReadGS1, tidy=FALSE, highlight=FALSE, cache=TRUE>>=
...
<<ReadGS2, tidy=FALSE, highlight=FALSE, cache=TRUE>>=
...
<<ReadGS3, tidy=FALSE, highlight=FALSE, cache=TRUE>>=
rjc.bib <- ReadGS(scholar.id = 'CJOHNoQAAAAJ', sort.by.date = FALSE, 
...
<<ReadCR1, tidy=FALSE, highlight=FALSE, cache=TRUE>>=
...
<<Print1, tidy=TRUE, highlight=FALSE, cache=TRUE>>=
...
<<Print2, tidy=FALSE, highlight=FALSE, cache=TRUE, dependson="Print1">>=
...
<<Search1, tidy=TRUE, highlight=FALSE, cache=TRUE>>=
file.name <- system.file("Bib", "biblatexExamples.bib", package="RefManageR")
bib <- ReadBib(file.name, check = FALSE)
bib[editor = "westfahl"]
@
...
<<Search1b, tidy=TRUE, highlight=FALSE, cache=TRUE>>=
bib[author = "westfahl"]
@
...
<<Search2, dependson="Search1", tidy=TRUE, highlight=FALSE>>=
...
<<RJC1, tidy=TRUE, eval= -3, highlight=FALSE, cache=TRUE>>=
file.name <- system.file("Bib", "RJC.bib", package="RefManageR")
bib <- ReadBib(file.name)
...
<<RJC2, tidy=FALSE, dependson="RJC1", highlight=FALSE, cache=TRUE>>=
bib <- bib[-ind[4L]]
...
<<RJC3, tidy=FALSE, dependson="RJC2", highlight=FALSE, cache=TRUE>>=
...
<<RJC4, tidy=FALSE, dependson="RJC3", highlight=FALSE, cache=TRUE, echo=-1>>=
BibOptions(sorting = "none", bib.style = "alphabetic")
bib2 <- bib[seq_len(3)]
bib2[2:3] <- bib[5:6]
bib2
