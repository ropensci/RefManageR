...
<<Search1, tidy=TRUE, highlight=TRUE, echo=-1, cache=TRUE>>=
...
<<RJC1, tidy=TRUE, eval= -3, highlight=TRUE, cache=TRUE, echo=-1>>=
file.name <- "C:\\Users\\Matthew\\Documents\\biblatex\\RefManageR\\code\\RefManageR\\sampleData\\RJC.bib"
...
print(bib[seq_len(3L)], sorting = "none", .bibstyle = "alphabetic")
bib[seq_len(3L)] <- list(c(date="2013-12"), ## add month to Serban et al.
